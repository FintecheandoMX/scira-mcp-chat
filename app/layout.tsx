...
export const metadata: Metadata = {
  ...
  title: "Agentic Chat with MCP support",
  description:
    "Agentic Chat with MCP support is a minimalistic MCP client with a good feature set.",
  openGraph: {
    siteName: " Agentic Chat with MCP support",
